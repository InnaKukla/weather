...
const WeatherDescription: React.FC<WeatherDataProps> = ({ weatherData }) => {
  ...
  return (
    <div className={`flex flex-col items-center`}>
      ...
      <div className="xl:flex xl:gap-20 xl:items-start justify-center">
        <div className="flex justify-between items-center gap-[35px] md:gap-[60px] lg:gap-[70px] xl:flex-col xl:gap-0 xl:flex xl:flex-1 xl:mt-10">
          <div className="mt-10 xl:mt-0 flex flex-col xl:flex-row gap-2 p-[16px] border border-solid rounded-2xl border-[#3f718b94] bg-[#3f718b94] ">
